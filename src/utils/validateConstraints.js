...
// Constraints schema
const constraintSchema = (componentList) =>
  object({
    name: string("Constraint Name must be a string")
      ...
      .test(
        "no-injection",
        "Constraint Name contains invalid characters",
        noInjection,
      ),
    ...
    stateKey: string("State Key must be a string")
      ...
      .test(
        "no-injection",
        "State Key contains invalid characters",
        noInjection,
      )
      .test("state-key-exists", "State Key does not exist", function (value) {
        ...
        return (
          component &&
          component.states.find((state) => state.key === value) !== undefined
        );
      }),
    type: string("Constraint Type must be a string")
      ...
      .test(
        "no-injection",
        "Constraint Type contains invalid characters",
        noInjection,
      ),
    stateType: string("State Type must be a string")
      ...
      .test(
        "no-injection",
        "State Type contains invalid characters",
        noInjection,
      ),
