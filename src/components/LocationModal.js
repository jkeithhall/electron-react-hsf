...
const mapOptions = {
  ...
  Alidade_Satellite: {
    ...
    maxZoom: 20,
    attribution:
      "&copy; CNES, Distribution Airbus DS &copy; Airbus DS &copy; PlanetObserver (Contains Copernicus Data) | &copy; Stadia Maps &copy; OpenMapTiles &copy; OpenStreetMap contributors",
  },
  Outdoors: {
    ...
    maxZoom: 20,
    attribution:
      "&copy; Stadia Maps &copy; OpenMapTile &copy; OpenStreetMap contributors",
  },
  Stamen_Toner_Lite: {
      ...
      >
        ...
        >
          ...
          <DraggableMarker
            ...
            setPosition={setMarkerLocation}
          />
        </MapContainer>
        <div className="confirm-close-icons">
          <Button
            variant="contained"
            onClick={onConfirm(markerLocation)}
            startIcon={<CheckIcon />}
          >
            Confirm
          </Button>
